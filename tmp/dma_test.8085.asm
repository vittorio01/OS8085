...
dma_memory_transfer:        mvi a,dma_mode_register_channel0+dma_mode_register_increment+dma_mode_register_autoinitialize+dma_mode_register_block_transfer+dma_mode_register_read_transfer
                            out dma_mode_register
                            mvi a,dma_mode_register_channel1+dma_mode_register_increment+dma_mode_register_autoinitialize+dma_mode_register_block_transfer+dma_mode_register_write_transfer
                            out dma_ff_clear
                            mov a,c 
