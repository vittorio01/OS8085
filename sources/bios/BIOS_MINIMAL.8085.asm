...
bios_device_disk_table:         .word bios_default_disk_initialize
                                ...
                                .word bios_default_disk_status
                                .word bios_default_disk_set_motor  
                                .word bios_default_disk_format_drive 
                                .byte bios_default_disk_heads_number
                                .word bios_default_disk_tph_number
                                .byte bios_default_disk_spt_number
                                .byte bios_default_disk_bps_coded_number

                                ;inserisci i dispositivi qui 
bios_device_disk_table_end: 

bios_default_disk_address_start          .equ $8000
bios_default_disk_address_end            .equ $ffff

bios_default_disk_heads_number           .equ 1
bios_default_disk_tph_number             .equ 16 
bios_default_disk_spt_number             .equ 8
bios_default_disk_bps_coded_number       .equ 2 
bios_default_disk_bps_uncoded_number     .equ 256
   
bios_default_disk_format_fill_byte       .equ $ff 
...
bios_default_disk_status:               ret 

bios_default_disk_format_drive:         ret  

bios_default_disk_set_motor:            ret 
